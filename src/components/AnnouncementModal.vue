  ...
  <Teleport to="body">
    <div v-if="visible" class="announcement-overlay" @click="handleClose">
      <div class="announcement-modal" @click.stop>
        ...
        <h1 class="modal-title">公告</h1>
        <h2 class="modal-subtitle">Benefer 战略升级新系统正式上线</h2>

        <div class="modal-content">
          <p>随着 Benefer 战略升级全面完成，</p>
          <p>全新系统现已正式上线运行。</p>
          <p><br /></p>
          <p>本次升级，</p>
          <p>不仅是系统层面的重构与优化，</p>
          <p>更是 Benefer 面向全球化生态布局的重要里程碑。</p>
          <p><br /></p>
          ...
          <p><br /></p>
          <p>为进一步推动 Benefer 全球化发展，</p>
          <p>BEF 基金会已联合日本财团完成 3000 万 USDT 战略注资。</p>
          <p><br /></p>
          <p>其中：</p>
          ...
          <p><br /></p>
          <p>本次战略资金注入，</p>
          <p>将进一步提升 Benefer 生态抗风险能力与长期增长空间。</p>
          <p><br /></p>
          <p><strong>三、ENI 生态即将迎来全面爆发</strong></p>
          <p>Benefer 正式开启全新征程</p>
          <p><br /></p>
          <p>随着 ENI 公链生态持续推进，</p>
          <p>Benefer 将全面协同 ENI 生态体系，</p>
          <p>进一步拓展全球市场与生态应用场景。</p>
          <p><br /></p>
          <p>新系统的正式上线，</p>
          <p>标志着 Benefer 已正式进入全新的战略发展阶段。</p>
          <p><br /></p>
          <p>新的征程已经开启，</p>
          <p>新的生态格局正在形成。</p>
          <p><br /></p>
        ...
        <div class="modal-footer">
          ...
          <p class="no-remind" @click="handleNoRemind">不再提醒</p>
        </div>
      </div>
    </div>
  </Teleport>
